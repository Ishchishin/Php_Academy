 ...
 */
$row  = 17; // строки в таблице
$cols = 21;   //столбцы в таблице
$colors = array('red','yellow','blue','gray','maroon','brown','green'); //список цветов
  echo "<table>";
  for ($i=0;$i<$row;$i++){
      echo "<tr>";
      for ($j=0;$j<$cols;$j++){
          echo "<td style='background-color:".$colors[rand(1,6)]."'>".rand(1,99999)."</td>" ;
      }
      echo "</tr>";
  }
?>